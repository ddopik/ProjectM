...
public class ProductsAdapter extends RecyclerView.Adapter {
    ...
    public ProductsAdapter(List<Products> productsList, List<UrgentCase> urgentCaseList, int defaultResId, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == HEADER_TYPE) {
            return new HeaderViewHolder(inflater.inflate(R.layout.urgent_case_item, parent, false));
        } else {
